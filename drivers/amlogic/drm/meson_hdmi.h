...
#define MESON_DEFAULT_FRACE_RATE_PCY 0
#define MESON_DEFAULT_HDCP_MODE HDCP_MODE22
#define MESON_DEFAULT_HDR_MODE  EOTF_T_SDR
...
struct am_hdmi_tx {
	...
	enum eotf_type hdr_mode;
	struct drm_property *color_depth_property;
	struct drm_property *color_space_property;
	struct drm_property *frac_rate_policy_property;
	...
	struct task_struct *test_modetest_work;
};
