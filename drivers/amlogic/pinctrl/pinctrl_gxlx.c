/*
 * drivers/amlogic/pinctrl/pinctrl_gxlx.c
 *
...
#include <dt-bindings/gpio/gxlx.h>
...
#define	PIN_GPIOH_11    (EE_OFFSET + GPIOH_11)
#define	PIN_GPIOH_12    (EE_OFFSET + GPIOH_12)
...
static struct pinctrl_pin_desc gxl_pads[] = {
	...
	MESON_PIN(GPIOH_11, "GPIOH_11"),
	MESON_PIN(GPIOH_12, "GPIOH_12"),
...
static struct meson_bank mesongxl_banks[] = {
	...
	BANK("DV",  PIN_GPIODV_0, PIN_GPIODV_29,
	     0,  0,  0,  0,  0,  0,  1,  0,  2,  0),
	BANK("H",    PIN_GPIOH_0,  PIN_GPIOH_11,
	     1, 20,  1, 20,  3, 20, 4, 20, 5, 20),
	BANK("H12",    PIN_GPIOH_12,  PIN_GPIOH_12,
	     1, 19,  1, 19,  3, 19, 4, 19, 5, 19),
...
static unsigned int gpio_to_pin[][6] = {
	...
	[PIN_GPIOX_8] = {PK(5, 23), PK(5, 13), PK(8, 19), PK(5, 3), PK(8, 23),
			NE,},
	[PIN_GPIOX_9] = {PK(5, 22), PK(5, 12), PK(8, 18), PK(5, 2), PK(8, 22),
			NE,},
	[PIN_GPIOX_10] = {PK(5, 21), PK(5, 11), PK(5, 5), PK(5, 1), PK(8, 21),
			NE,},
	...
	[PIN_GPIOH_10] = {PK(8, 0), PK(8, 1), NE, NE, NE, NE,},
	[PIN_GPIOH_11] = {PK(8, 2), PK(8, 3), PK(8, 4), NE, NE, NE,},
	[PIN_GPIOH_12] = {NE, NE, PK(8, 5), PK(8, 6), NE, NE,},
	...
	[PIN_GPIOZ_14] = {PK(8, 8), PK(3, 21), PK(4, 25), NE, NE, NE,},
	[PIN_GPIOZ_15] = {PK(8, 9), PK(3, 20), PK(4, 24), NE, NE, NE,},
...
static int gxl_extern_gpio_get(struct meson_domain *domain, unsigned int pin)
{
	if (PIN_GPIO_TEST_N == pin)
...
static struct of_device_id gxl_pinctrl_of_table[] = {
	{
		.compatible = "amlogic, pinmux-gxlx",
	},
	{},
};
...
MODULE_DESCRIPTION("gxlx pin control driver");
