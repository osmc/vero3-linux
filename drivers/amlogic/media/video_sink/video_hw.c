	...
	const struct vinfo_s *vinfo)
{
	...
	if (((vf->type & VIDTYPE_NO_VIDEO_ENABLE) == 0) &&
		...
		if ((first_picture && layer->disable_video != VIDEO_DISABLE_NORMAL)
				|| (vf->type & VIDTYPE_MVC))
			enable_layer = true;
...
#define __DUMP_VIU_REG(a) { \
	u32 val = VSYNC_RD_MPEG_REG(a + cur_dev->viu_off); \
...
{
	__DUMP_VIU_REG(VD1_IF0_CANVAS0);
	__DUMP_VIU_REG(VD1_IF0_CANVAS1);
	__DUMP_VIU_REG(VD1_IF0_CHROMA0_RPT_PAT);
	__DUMP_VIU_REG(VD1_IF0_CHROMA1_RPT_PAT);
	__DUMP_VIU_REG(VD1_IF0_CHROMA_PSEL);
	__DUMP_VIU_REG(VD1_IF0_CHROMA_X0);
	__DUMP_VIU_REG(VD1_IF0_CHROMA_X1);
	__DUMP_VIU_REG(VD1_IF0_GEN_REG);
	__DUMP_VIU_REG(VD1_IF0_LUMA0_RPT_PAT);
	__DUMP_VIU_REG(VD1_IF0_LUMA1_RPT_PAT);
	__DUMP_VIU_REG(VD1_IF0_LUMA_PSEL);
	__DUMP_VIU_REG(VD1_IF0_LUMA_X0);
	__DUMP_VIU_REG(VD1_IF0_LUMA_X1);
	__DUMP_VIU_REG(VD1_IF0_LUMA_Y0);
	__DUMP_VIU_REG(VD1_IF0_CHROMA_Y0);
	__DUMP_VIU_REG(VD1_IF0_LUMA_Y1);
	__DUMP_VIU_REG(VD1_IF0_CHROMA_Y1);
	__DUMP_VIU_REG(VIU_VD1_FMT_CTRL);
	__DUMP_VIU_REG(VIU_VD1_FMT_W);
	__DUMP_VIU_REG(VD2_IF0_CANVAS0);
	__DUMP_VIU_REG(VD2_IF0_CANVAS1);
	__DUMP_VIU_REG(VD2_IF0_CHROMA0_RPT_PAT);
	__DUMP_VIU_REG(VD2_IF0_CHROMA1_RPT_PAT);
	__DUMP_VIU_REG(VD2_IF0_CHROMA_PSEL);
	__DUMP_VIU_REG(VD2_IF0_CHROMA_X0);
	__DUMP_VIU_REG(VD2_IF0_CHROMA_X1);
	__DUMP_VIU_REG(VD2_IF0_LUMA_Y0);
	__DUMP_VIU_REG(VD2_IF0_CHROMA_Y0);
	__DUMP_VIU_REG(VD2_IF0_LUMA_Y1);
	__DUMP_VIU_REG(VD2_IF0_CHROMA_Y1);
	__DUMP_VIU_REG(VD2_IF0_GEN_REG);
	__DUMP_VIU_REG(VD2_IF0_LUMA0_RPT_PAT);
	__DUMP_VIU_REG(VD2_IF0_LUMA1_RPT_PAT);
	__DUMP_VIU_REG(VD2_IF0_LUMA_PSEL);
	__DUMP_VIU_REG(VD2_IF0_LUMA_X0);
	__DUMP_VIU_REG(VD2_IF0_LUMA_X1);
	__DUMP_VIU_REG(VIU_VD2_FMT_CTRL);
	__DUMP_VIU_REG(VIU_VD2_FMT_W);
