...
void dump_some_registers(void)
{
	...
	__DUMP_VPP_REG(VPP_IN_H_V_SIZE);
	__DUMP_VPP_REG(VPP_LINE_IN_LENGTH);
	__DUMP_VPP_REG(VPP_MISC);
	__DUMP_VPP_REG(VPP_PIC_IN_HEIGHT);
	...
	__DUMP_VPP_REG(VPP_VE_H_V_SIZE);
	__DUMP_VPP_REG(VPP_PSR_H_V_SIZE);
}
