	...
	const struct vinfo_s *info)
{
	...
	*setting->frame_par = *layer->cur_frame_par;
	...
	setting->frame_par->VPP_pic_in_height_ >>= 1;
	setting->frame_par->VPP_line_in_length_ >>= 1;
	...
	struct vframe_s *dvel_vf)
{
	...
	setting->postblend_h_start = setting->frame_par->VPP_hsc_startp;
	setting->postblend_h_end = setting->frame_par->VPP_hsc_endp;
	setting->postblend_v_start = setting->frame_par->VPP_vsc_startp;
	setting->postblend_v_end = setting->frame_par->VPP_vsc_endp;
