...
static void canvas_pool_config(void)
{
	...
	canvas_pool_register_const_canvas(0, 0x1a, "amvdec"); /* keep AMVDEC_CANVAS_* values in canvas.h up-to-date if you change anything here */
	...
	canvas_pool_register_const_canvas(0x78, 0xd7, "amvdec"); /* keep AMVDEC_CANVAS_* values in canvas.h up-to-date if you change anything here */
	canvas_pool_register_const_canvas(0xd8, 0xe3, "encoder");
