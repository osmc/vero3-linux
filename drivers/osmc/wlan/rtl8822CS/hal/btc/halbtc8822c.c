...
static const struct btc_rf_para rf_para_tx_8822c[] = {
				...
				{7, 8, TRUE, 7},
				{6, 10, TRUE, 7},
				{8, 0, TRUE, 7}, /* 6 for RCU OFC */
				{8, 0, TRUE, 7},
				{6, 0, TRUE, 7},
				{6, 0, TRUE, 7},
				{16, 4, TRUE, 7}, /* 10 for A2DP SDR */
				{15, 5, TRUE, 7},
				{7, 8, TRUE, 7},
				{6, 10, TRUE, 7},
				{8, 0, TRUE, 7}, /* 14 for A2DP OFC */
				{8, 0, TRUE, 7},
				{6, 0, TRUE, 7},
				{6, 0, TRUE, 7},
				{16, 4, TRUE, 7}, /* 18 for A2DP+RCU SDR */
				{15, 5, TRUE, 7},
				{7, 8, TRUE, 7},
				{6, 10, TRUE, 7},
				{10, 0, TRUE, 7}, /* 22 for A2DP+RCU OFC */
				{8, 0, TRUE, 7},
				{6, 0, TRUE, 7},
				{6, 0, TRUE, 7} };
...
static const struct btc_rf_para rf_para_rx_8822c[] = {
				...
				{7, 8, TRUE, 7},
				{6, 10, TRUE, 7},
				{10, 4, TRUE, 7}, /* 22 for A2DP+RCU OFC */
				{8, 5, TRUE, 7},
				{6, 8, TRUE, 7},
				{6, 10, TRUE, 7} };
