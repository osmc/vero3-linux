...
#define RPU_SHM_SIZE (512 * sizeof(char) + 7 * sizeof(int32_t))
...
int parse_rpu(char *rpu_data_rbsp, uint16_t rpu_size, uint16_t *dm_size, uint32_t *master_info)
{
	struct tee_ioctl_invoke_arg args = {0};
	struct tee_param param[4] = {0};
