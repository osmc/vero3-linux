...
static void rtl8211f_set_rxtx_delay(struct phy_device *phydev)
{
	...
	} else if (phydev->interface == PHY_INTERFACE_MODE_RGMII_TXID || phydev->interface == PHY_INTERFACE_MODE_RGMII_ID) {
		/* enable TX-delay for rgmii-id and rgmii-txid, otherwise disable it */
		has_tx_delay = 1;
	} else if (phydev->interface == PHY_INTERFACE_MODE_RGMII_RXID || phydev->interface == PHY_INTERFACE_MODE_RGMII_ID) {
