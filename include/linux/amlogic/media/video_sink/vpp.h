...
#define MODE_3D_FULL_LRTB   0x00000040
...
#define MODE_3D_MVC_TO_SBS (MODE_3D_ENABLE | MODE_3D_OUT_LR | MODE_3D_FA)
#define MODE_3D_MVC_TO_TAB (MODE_3D_ENABLE | MODE_3D_OUT_TB | MODE_3D_FA)
