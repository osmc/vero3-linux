...
//	       runtime->rate, samesrc);
	pr_info("aml_hw_iec958_init,runtime->rate=%d, runtime->channels=%d\n        same source mode(%d), stream format=%s\n",
	       runtime->rate, runtime->channels, samesrc, spdif_format_texts[IEC958_mode_codec]);
